...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 08, 2022 lúc 10:33 AM
...
(55, 'Trần Thiên Vạn', '0999994566', '0123448588', 'nam', 'daidien', 5950000, '1', 35, 20),
...
(14, '0', 'Du Lịch Quy Nhơn & Tuy Hoà : Hà Nội - Quy Nhơn - Tuy Hòa 4N3Đ (Đi Quy Nhơn - Về Tuy Hoà)', '5600000', '1655569153_quy-nhon.jpg', '2022-07-04', '2022-07-30', '2022-07-31', 'Bình Định', 'Đến với Quy Nhơn, bạn có thể tắm biển ngay ở những bãi gần trung tâm mà không phải đi xa. ', '<p>Ghềnh R&aacute;ng&nbsp;trải d&agrave;i dọc bờ biển trong xanh, v&agrave; từ đ&acirc;y c&oacute; thể nh&igrave;n thấy th&agrave;nh phố Quy Nhơn. Nơi đ&acirc;y c&oacute; b&atilde;i Đ&aacute; Trứng với v&ocirc; số h&ograve;n đ&aacute; tr&ograve;n nhẵn như trứng chim khổng lồ, b&atilde;i tắm Ho&agrave;ng Hậu. &nbsp;Mộ nh&agrave; thơ H&agrave;n Mặc Tử nằm tr&ecirc;n đồi Thi Nh&acirc;n v&agrave; Lầu</p>\r\n', '1655569153_S1-E-Book-How-To-Make-Hits.pdf', 0, 60),
...
--
ALTER TABLE `tbl_dangkytour`
  MODIFY `id_dangkytour` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT cho bảng `tbl_dangkytour_chitiet`
--
ALTER TABLE `tbl_dangkytour_chitiet`
  MODIFY `id_dangkytour_chitiet` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `tbl_nhan_hotro`
  MODIFY `id_nhan_hotro` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `tbl_tourdulich_liked`
  MODIFY `id_tourdulich_liked` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
