<?php
 ...
 $today = Carbon::now('Asia/Ho_Chi_Minh')->toDateString();
    ...
    function tour_login($dangkytruoc, 
    $soluongdadangky, 
    $soluongtoida, 
    $idtour, 
    $imgtour, 
                    ...
                    <div class="content__tour-item">
                        ...
                        <?php 
                                                    if(isset($_SESSION['user_login']))
                                                    {
                                                        ...
                                                        if($check_tour_like_count > 0){
                                                            ?><div class="content__tour-item-like liked"><a
                                href="modules/container/tour/tour_like_xuly.php?select=unlike&idtour=<?php echo $tour_moi_row['id_tourdulich']?>"><i
                                    class="fa-solid fa-heart"></i></a></div><?php
                                                        }
                                                        else{
                                                            ?><div class="content__tour-item-like"><a
                                href="modules/container/tour/tour_like_xuly.php?select=like&idtour=<?php echo $tour_moi_row['id_tourdulich']?>"><i
                                    class="fa-solid fa-heart"></i></a></div><?php
                                                        }
                                                    ?>
                        <?php
